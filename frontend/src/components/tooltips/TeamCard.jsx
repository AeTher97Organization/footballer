    ...
    return (
        <div className={classes.standardBorder}
            ...
            <div style={{display: 'flex', justifyContent: 'center'}}>
                <TeamPicture size={'medium'} player1Hash={team.players[0].avatarHash}
                             player2Hash={team.players[1].avatarHash}/>
            </div>
            <div className={classes.centeredRow} style={{maxWidth: 200}}>
                <Typography noWrap style={{overflow: 'hidden', textOverflow: 'ellipsis'}} color={"primary"}
                            variant={"h6"}>{team.teamWithStats.name}</Typography>
            </div>
